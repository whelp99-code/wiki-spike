...
def provision(output_dir: Path) -> None:
    ...
    print("Status and operation require a separately deployment-injected authority composition.")
    print("Provisioning grants no live, shadow, cutover, or serving authority.")
