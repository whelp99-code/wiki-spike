...
quiesce writers -> immutable snapshot -> zero-write proof
        ...
        (registers a source)    (freezes the SLOs)
                                      |
                                      v
                            at least 3 full shadow days (72 hours)
...
observation, so signing it starts the at-least-3-full-day clock. This proposed floor does
not create a signed DB-05 or DB-07 authority, and a signed superseding
reconciliation remains required before any operational claim. It is not free of
